...

{
  ...
  bool                                init_guess_changed;
  bool                                downsample_child_points_;
  bool                                downsample_parent_points_;
  ...
  ros::Publisher calibration_stat_pub;
  /*!
  ...
  void UpdateCurrentGuessWithLookup();

  lidar_calib_test_bridge* bridge;
